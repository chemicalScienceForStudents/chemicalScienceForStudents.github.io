...
function createGraph(data) {
    ...
    let widthGraph = grafica.offsetWidth
    let heightGraph = grafica.offsetHeight

    console.log(widthGraph,heightGraph)

    // crear grafica 
     let width = 500
     let height = 280

    // crear grafica con valores reales
    // let width = widthGraph
    // let height = heightGraph
    ...
    .enter()
    .append("circle")
    .attr("cx", (d, i) => (d[0]*10)+padding)
    .attr("cy", d=> height - (d[1]*20+padding))
    .attr("r", 5)
    .attr("fill",'#959CE8')
